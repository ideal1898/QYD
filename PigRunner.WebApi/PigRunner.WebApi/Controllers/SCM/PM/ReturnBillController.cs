...
namespace PigRunner.WebApi.Controllers.SCM.PM
{
    ...
    [ApiController]
    public class ReturnBillController:ControllerBase
    {
        /// <summary>
        /// 采购退货单服务
        /// </summary>
        private IReturnBillService orderService;
        /// <summary>
        /// 服务注册
        /// </summary>
        public ReturnBillController(IReturnBillService _orderService)
        {
        ...
        //[AllowAnonymous]
        [HttpPost]
        public ResponseBusBody save([FromBody] ReturnBillView vo)
        {
        ...
        //[AllowAnonymous]
        [HttpPost]
        public ResponseBusBody submit([FromBody] ReturnBillView vo)
        {
        ...
        //[AllowAnonymous]
        [HttpPost]
        public ResponseBusBody approve([FromBody] ReturnBillView vo)
        {
        ...
        [AllowAnonymous]
        [HttpPost]
        public ResponseBusBody unapprove([FromBody] ReturnBillView vo)
        {
