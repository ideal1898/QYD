...
namespace PigRunner.DTO.Scm.Inv
{
    ...
    public class WhbinAdjustView : DocBaseView
    {
        ...
        public List<WhbinAdjustLineView> Lines { get; set; } = new List<WhbinAdjustLineView>();

    }
    public class WhbinAdjustLineView : BaseView
    {
