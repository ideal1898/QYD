...
namespace PigRunner.DTO.MM.PM
{
    ...
    /// 领料单视图
    /// </summary>
    public class IssueView:OrderBaseView
    {
        ...
        /// 领料明细
        /// </summary>
        public List<IssueLineView> IssueLines { get; set; } = new List<IssueLineView>();
    }

    /// <summary>
    /// 领料单行视图
    /// </summary>
    public class IssueLineView
    {
        /// <summary>
        /// 业务主键
        /// </summary>
