...
{
    public interface IRtnIssueService : IScopedService
    {
        #region 业务处理
        /// <summary>
        /// 保存
        ...
        /// <returns></returns>
        ResponseBusBody Save(RtnIssueView view);
        /// <summary>
        /// 删除
        /// </summary>
        ...
        ResponseBusBody Submit(RtnIssueView view);
        ResponseBusBody Approve(RtnIssueView view);
        ResponseBusBody UnApprove(RtnIssueView view);
